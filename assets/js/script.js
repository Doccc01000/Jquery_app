(function ($) {
    ...
    $(".mode").on("click", function () {
        ...
        $('.dark-mode').toggleClass("text-white");
        localStorage.setItem('body', 'dark-only');
        let darkOnly = $('body').hasClass('dark-only');
        const backgroundElement = $('.knowledgebase-bg')
        if(darkOnly) 
            backgroundElement.css({"background-image": "url('./assets/images/knowledgebase/bg_guitar_dark.jpg')"});
        else 
            backgroundElement.css({"background-image": "url('./assets/images/knowledgebase/bg_guitar.jpg')"});
    });
